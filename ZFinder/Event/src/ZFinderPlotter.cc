    ...
    void ZFinderPlotter::Fill(
        ...
        if (!USE_MC_) {
            ...
            if (ELECTRON_0 == 0 && ELECTRON_1 == 1) {
                ...
                if (ZF_EVENT.e0 != NULL) {
                    e0_pt_->Fill(ZF_EVENT.e1->pt, EVENT_WEIGHT);
                    e0_pt_naked_->Fill(ZF_EVENT.e1->nakedPt, EVENT_WEIGHT);
                    e0_pt_born_->Fill(ZF_EVENT.e1->bornPt, EVENT_WEIGHT);
                    e0_eta_->Fill(ZF_EVENT.e1->eta, EVENT_WEIGHT);
                    e0_eta_naked_->Fill(ZF_EVENT.e1->nakedEta, EVENT_WEIGHT);
                    e0_eta_born_->Fill(ZF_EVENT.e1->bornEta, EVENT_WEIGHT);
                    e0_phi_->Fill(ZF_EVENT.e1->phi, EVENT_WEIGHT);
                    e0_phi_naked_->Fill(ZF_EVENT.e1->nakedPhi, EVENT_WEIGHT);
                    e0_phi_born_->Fill(ZF_EVENT.e1->bornPhi, EVENT_WEIGHT);
                    e0_charge_->Fill(ZF_EVENT.e1->charge, EVENT_WEIGHT);
                }
                if (ZF_EVENT.e1 != NULL) {
                    e1_pt_->Fill(ZF_EVENT.e0->pt, EVENT_WEIGHT);
                    e1_pt_naked_->Fill(ZF_EVENT.e0->nakedPt, EVENT_WEIGHT);
                    e1_pt_born_->Fill(ZF_EVENT.e0->bornPt, EVENT_WEIGHT);
                    e1_eta_->Fill(ZF_EVENT.e0->eta, EVENT_WEIGHT);
                    e1_eta_naked_->Fill(ZF_EVENT.e0->nakedEta, EVENT_WEIGHT);
                    e1_eta_born_->Fill(ZF_EVENT.e0->bornEta, EVENT_WEIGHT);
                    e1_phi_->Fill(ZF_EVENT.e0->phi, EVENT_WEIGHT);
                    e1_phi_naked_->Fill(ZF_EVENT.e0->nakedPhi, EVENT_WEIGHT);
                    e1_phi_born_->Fill(ZF_EVENT.e0->bornPhi, EVENT_WEIGHT);
                    e1_charge_->Fill(ZF_EVENT.e0->charge, EVENT_WEIGHT);
                }
                if (ZF_EVENT.e1_trig != NULL && ZF_EVENT.e1_truth != NULL) {
                    e0_pt_vs_trig_->Fill(
